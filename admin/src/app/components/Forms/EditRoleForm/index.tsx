...
import EditRoleValidationSchema from "./EditRoleValidation"; 
import { EditRoleFormDataTypes, EditUserFormDataTypes } from "@/types";
import Link from "next/link";
import { RoleData } from "../../Roles/roles";
...
export default function EditRoleForm({
  ...
  setRoleDetails: React.Dispatch<React.SetStateAction<RoleData | undefined>>;
  onEditingRole: (EditRoleData:EditRoleFormDataTypes) => Promise<void>;
}) {
  ...
  const {
    ...
    resolver: yupResolver(EditRoleValidationSchema),
  });

  return (
    <form onSubmit={handleSubmit(onEditingRole)}>
