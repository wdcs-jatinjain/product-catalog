...
//     //     authenticate: (
//     //       arg0: string,
//     //       arg1: { email: any; password: any }
//     //     ) => PromiseLike<{ customer: any }> | { customer: any };
//     //     login: (arg0: any) => any;
//     //   }
//     // ) => {
//     //   try {
...
//     //     const { customer } = await context.authenticate("graphql-local", {
//     //       email,
//     //       password,
//     //     });
...
//     //     res: { clearCookie: (arg0: string) => void };
//     //   }
//     // ) => {
//     //   try {
...
//   },
//   Query: {
//     // authClient: async (_: any, __: any, context: { getUser: () => any }) => {
//     //   try {
